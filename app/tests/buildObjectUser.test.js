...
it('expect moodle object user populate', () => {
    ...
    params = {"moodle":{"body":{"username":{"email_address":""},"password":["Fcamara@",{"merge_fields":{"MMERGE6":""}}],"firstname":{"merge_fields":{"FNAME":""}},"lastname":{"merge_fields":{"LNAME":""}},"email":{"email_address":""}}}};
    result = [{"username":"test@outlook.com","password":"Fcamara@1992-02-22","firstname":"Leon","lastname":"Freitas","email":"test@outlook.com"}];
